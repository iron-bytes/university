...
I router estraggono i campi di intestazione dai datagrammi, che li usano come indice nella tabella di inoltro. Il valore trovato indica a quale interfaccia di uscita il segmento debba essere diretto.
\begin{table}[h!]
	\centering
	\begin{tabular}{|c|c|}
		\hline
