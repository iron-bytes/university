...
BGP determina le tabelle di inoltro esterne all'AS. BGP non instrada però verso uno specifico indirizzo, bensì verso prefissi CIDR, ovvero delle sottoreti, come ad esempio \texttt{138.16.68.0/22}.
